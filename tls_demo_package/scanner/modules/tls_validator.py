...
WEAK_CIPHERS = {
    ...
    "DES-CBC": {"severity": "CRITICAL", "reason": "DES has 56-bit key"},
    "3DES": {"severity": "HIGH", "reason": "3DES is deprecated"},
    "IDEA": {"severity": "HIGH", "reason": "IDEA has limited support"},
    "EXPORT": {"severity": "CRITICAL", "reason": "Export-grade cipher with weak key"},
    "NULL": {"severity": "CRITICAL", "reason": "NULL cipher provides no encryption"},
    "ANON": {"severity": "CRITICAL", "reason": "Anonymous cipher has no authentication"},
}
